...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a href="#research" class="nav-link smoothScroll">research</a>
          </li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="mx-auto col-lg-5 col-md-5 col-10">
          <img src="images/satawat.png" class="img-fluid" alt="Satawat HTML Template">
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          <ul class="mt-4 mb-5 mb-lg-0 profile-list list-unstyled">
            <li><strong>ผู้ช่วยศาสตราจารย์</strong> ศตวรรษ ทิพโสต </li>
            <li><strong>Assisstant Professor</strong> Satawat Thipsod </li>
            <li>
            Marketing, Faculty of Management Science
            Rambhai Barni Rajabhat University</li>
          </ul>
          
          <h5 class="mt-5">การศึกษา</h5>
          <h6>ปริญญาโท</h6>
          <p><b>บธ.ม.(การตลาด) มหาวิทยาลัยเทคโนโลยีมหานคร</b></p>
          <h6>ปริญญาตรี</h6>
          <p><b> บธ.บ.(การตลาด) มหาวิทยาลัยรามคำแหง</b></p>


        </div>

        <div class="col-lg-5 mx-auto col-md-6 col-12">
          <img src="images/333619.jpg" class="about-image img-fluid" alt="Ben's Resume HTML Template">
        </div>
  ...
  <section id="slide">
    <div class="container">
    <h3 class="mb-4">เอกสารประกอบการสอน</h3>
  <iframe src="https://drive.google.com/embeddedfolderview?id=1phYluMqYWaA5YcUiEtdbXVy3Jg7FqV85#list" style="width:100%; height:600px; border:0;"></iframe>
    </div>
  </section>
